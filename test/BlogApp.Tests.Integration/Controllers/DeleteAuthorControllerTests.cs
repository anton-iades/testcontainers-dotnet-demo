...
public class DeleteAuthorControllerTests : IClassFixture<IntegrationTestFactory<Program, BlogContext>>
{
    private readonly IntegrationTestFactory<Program, BlogContext> factory;

    private readonly IFixture fixture;

    public DeleteAuthorControllerTests(IntegrationTestFactory<Program, BlogContext> factory)
    {
    ...
    public async Task Should_Delete_Author()
    {
        ...
        // Act
        var response = await client.DeleteAsync($"authors/{createdAuthor.Id}");
    ...
    public async Task Should_Be_Bad_Request()
    {
        ...
        // Act
        var response = await client.DeleteAsync($"authors/not-a-guid");
